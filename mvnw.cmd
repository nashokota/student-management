...
@REM check for pre script, once with hierarchical, once with non-hierarchical config
...
@REM check for post script, once with hierarchical, once with non-hierarchical config
